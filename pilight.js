...
//  2018-04:  add opened/closed in all language-items
var language_en = {
	off: "Off",
	on: "On",
	opened: "Opened",
...
//  2018-04: begin insert contact function
function createContactElement(sTabId, sDevId, aValues) {
	...
	if($('#'+sDevId+'_contact').length == 0) {		
		...
		if('name' in aValues) {
			oTab.append($('<li id="'+sDevId+'" class="contact" data-icon="false">  <div class="name">'
				+aValues['name']+'</div> <div id="'+sDevId+'_contact" class="contact green">  </div> </li>'));			
		}	
...
//  2018-04: end insert contact function
...
function createGUI(data) {
	...
	$.each(data['gui'], function(dindex, dvalues) {
		...
		} else if(aValues['type'] == 6) {											//  insert 2018-04
			createContactElement(alphaNum(lindex), dindex, aValues);				//  insert 2018-04	
	...
	if(data.hasOwnProperty("devices")) {
		...
		$.each(aDevices, function(dindex, dvalues) {
			$.each(aValues, function(vindex, vvalues) {
				...
				} else if(iType == 6) {													//  insert 2018-04
					if(vindex == 'state' && $('#'+dvalues+'_contact').length > 0) { 	//  insert 2018-04
						if(vvalues == 'opened') { 										//  insert 2018-04
							$('#'+dvalues+'_contact').text (language.opened);			//  insert 2018-04
							$('#'+dvalues+'_contact').addClass ('red').removeClass('green' ); 	//  insert 2018-04
						} else {														//  insert 2018-04		
							$('#'+dvalues+'_contact').text (language.closed);			//  insert 2018-04
							$('#'+dvalues+'_contact').addClass ('green').removeClass('red' );	//  insert 2018-04
						}																//  insert 2018-04
					}	
				} else if(iType == 8) {
